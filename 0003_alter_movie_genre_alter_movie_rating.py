# Generated by Django 5.0.6 on 2024-05-14 11:10
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('crud_operation', '0002_alter_movie_release_date'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='movie',
            name='rating',
            field=models.IntegerField(blank=True, choices=[(1, '1 Star'), (2, '2 Star'), (3, '3 Star'), (4, '4 Star'), (5, '5 Star')], default=3, help_text='select the rating'),
        ),
    ]
